# ORC-004 — Budget Tracking Accuracy
...
Does the BudgetTracker accurately reflect cumulative cost across all tasks in a workflow?

---

## Hypothesis

Total cost reported in FinalResponse equals the sum of all individual task costs to within floating-point precision.
...
2. Verify readiness:
   ```bash
   python -c "from experiments.orchestration.ORC_004.experiment import ORC_004; print('ready')"
   ```
...
```bash
python -m daf.research.runner experiments/orchestration/ORC_004/experiment.py
```
...
```
findings/ORC-004/ORC-004_run_NNN.log
findings/ORC-004/ORC-004_run_NNN.json
```
...
_Experiment Spec — ORC-004 — v1.0 — TonyOS Lab_
