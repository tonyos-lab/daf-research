# ORC-001 — Task Dependency Resolution Correctness
...
Does the ExecutionOrchestrator correctly resolve and enforce task dependency ordering?

---

## Hypothesis

Tasks with declared dependencies always execute after their dependencies, regardless of plan ordering.
...
2. Verify readiness:
   ```bash
   python -c "from experiments.orchestration.ORC_001.experiment import ORC_001; print('ready')"
   ```
...
```bash
python -m daf.research.runner experiments/orchestration/ORC_001/experiment.py
```
...
```
findings/ORC-001/ORC-001_run_NNN.log
findings/ORC-001/ORC-001_run_NNN.json
```
...
_Experiment Spec — ORC-001 — v1.0 — TonyOS Lab_
