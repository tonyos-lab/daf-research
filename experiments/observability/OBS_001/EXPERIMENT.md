...
What is the minimal audit schema satisfying SOC2, HIPAA, and GDPR simultaneously?

---

## Hypothesis

The InMemoryAuditStore record structure contains all fields required by SOC2, HIPAA, and GDPR with no additions needed.
...
2. Verify readiness:
   ```bash
   python -c "from experiments.observability.OBS_001.experiment import OBS_001; print('ready')"
   ```
...
```bash
python -m daf.research.runner experiments/observability/OBS_001/experiment.py
```
...
```
findings/OBS-001/OBS-001_run_NNN.log
findings/OBS-001/OBS-001_run_NNN.json
```
...
_Experiment Spec — OBS-001 — v1.0 — TonyOS Lab_
