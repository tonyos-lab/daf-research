...
Under what PolicyMatrix configurations is Governed Agentic Loop termination formally guaranteed?

---

## Hypothesis

The loop always terminates within max_replan_attempts+1 iterations regardless of LLM output.
...
2. Verify readiness:
   ```bash
   python -c "from experiments.reliability.REL_003.experiment import REL_003; print('ready')"
   ```
...
```bash
python -m daf.research.runner experiments/reliability/REL_003/experiment.py
```
...
```
findings/REL-003/REL-003_run_NNN.log
findings/REL-003/REL-003_run_NNN.json
```
...
_Experiment Spec — REL-003 — v1.0 — TonyOS Lab_
