...
2. Verify readiness:
   ```bash
   python -c "from experiments.cost.CST_005.experiment import CST_005; print('ready')"
   ```
...
```bash
python -m daf.research.runner experiments/cost/CST_005/experiment.py
```
...
```
findings/CST-005/CST-005_run_NNN.log
findings/CST-005/CST-005_run_NNN.json
```
...
_Experiment Spec — CST-005 — v1.0 — TonyOS Lab_
