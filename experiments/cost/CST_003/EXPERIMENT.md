...
2. Verify readiness:
   ```bash
   python -c "from experiments.cost.CST_003.experiment import CST_003; print('ready')"
   ```
...
```bash
python -m daf.research.runner experiments/cost/CST_003/experiment.py
```

**Expected duration:** 45 minutes
**Expected cost:** $4.00 (live API)
...
```
findings/CST-003/CST-003_run_NNN.log
findings/CST-003/CST-003_run_NNN.json
```
...
_Experiment Spec — CST-003 — v1.0 — TonyOS Lab_
