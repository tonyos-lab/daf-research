...
2. Verify readiness:
   ```bash
   python -c "from experiments.cost.CST_006.experiment import CST_006; print('ready')"
   ```
...
```bash
python -m daf.research.runner experiments/cost/CST_006/experiment.py
```

**Expected duration:** 30 minutes
**Expected cost:** $2.00 (live API)
...
```
findings/CST-006/CST-006_run_NNN.log
findings/CST-006/CST-006_run_NNN.json
```
...
_Experiment Spec — CST-006 — v1.0 — TonyOS Lab_
