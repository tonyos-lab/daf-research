# HIL-004 — HITL Timeout Behaviour
...
How does the loop handle a HITL gateway that times out?

---

## Hypothesis

A timed-out HumanReviewResponse is treated identically to a rejection and triggers replan.
...
2. Verify readiness:
   ```bash
   python -c "from experiments.human_in_loop.HIL_004.experiment import HIL_004; print('ready')"
   ```
...
```bash
python -m daf.research.runner experiments/human_in_loop/HIL_004/experiment.py
```
...
```
findings/HIL-004/HIL-004_run_NNN.log
findings/HIL-004/HIL-004_run_NNN.json
```
...
_Experiment Spec — HIL-004 — v1.0 — TonyOS Lab_
